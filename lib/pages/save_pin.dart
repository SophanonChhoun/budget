...
class SavePin extends StatefulWidget {
  @override
  _SavePinState createState() => _SavePinState();
}

class _SavePinState extends State<SavePin> {
  @override
        ...
        Padding(
          ...
          child: IconButton(
            onPressed: () {
              ...
              authRepo.savePin(strPin).then((value) {
